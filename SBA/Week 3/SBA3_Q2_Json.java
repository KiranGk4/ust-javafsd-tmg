...
public class SBA3_Q2_Json {
	...
	public static void main(String[] args)throws Exception {
		...
		try
		{
			...
			JSONArray jsonArray = (JSONArray)p.parse(new FileReader("C:\\\\Users\\\\ustjavafsdb208\\\\Downloads\\\\EmployeeData.json"));
			Iterator it = jsonArray.iterator();
			
			String heading[] = {"id","name","email","password","about","token","country","location","lng","lat","dob","gender"};
			
			int row = 0, col = 0;
			HSSFWorkbook wb = new HSSFWorkbook();
			FileOutputStream fo = new FileOutputStream(new File("C:\\Users\\ustjavafsdb208\\Downloads\\Data.xls"));
